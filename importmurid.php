...
<head>
    <link rel="stylesheet" href="css/importmuridstyle.css?v=<?php echo time(); ?>">
    <title>Import Murid</title>
</head>
    <!-- header mula -->
        <div class="space">
            <div class="header">
    ...
    <!-- header tamat -->
            <div class="maincontent">
                <div class="title">IMPORT NAMA MURID DARI FAIL CSV</div>
                <div class="separator"></div>
                <div class="detailbox">
                    <h3>
                    <form class="uploadform" action="importcsv.php" method="post" name="upload_excel" enctype="multipart/form-data">
                        <div class="forminput">
                        ...
                        <form action="importcsv.php" method="post" name="daftarmurid" enctype="multipart/form-data">
                            ...
                            <button class="submit" type="submit" id="import" name="import">Muat Naik</button>
                        </form>
                        <br>
